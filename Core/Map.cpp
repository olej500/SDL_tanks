...
bool Map::load(char mapName[], char imageName[])
{
    ...
    ifstream in("graphics/maps/level1.txt");
    ofstream of("graphics/maps/fileout.txt");
    ...
    int randomY = rand()%16;
    int randomX = rand()%9;
    int randomT = rand()%wallChance;
    int tileSelect = rand()%2;

    of << "width " << width << endl;
    of << "height " << height << endl;
    of << "tile_width " << tileWidth << endl;
    of << "tile_height " << tileHeight << endl;
    of << "solid_tiles " << endl;
    of << "2, 3" << endl;
    of << "layer1" << endl;
    ...
    for(int i=0; i<9; i++)
    {
        for(int j=0; j<16; j++)
        {
            ...
            else if((i<6 && j>3) || (i>2 && j<12))
            {
                randomT = rand()%wallChance;
                if(randomT==0)
                {
                    tileSelect = rand()%2;
                    if(tileSelect==0)
    ...
    remove("graphics\\maps\\level1.txt");

    rename("graphics\\maps\\fileout.txt",
           "graphics\\maps\\level1.txt");
